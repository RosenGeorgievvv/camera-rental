...
const NavBar = ({ theme, setTheme }) => {
  ...
  return (
    <div className={`navbar ${theme}`}>
      <img
        src={theme === "light" ? logo : magicLight}
        alt=""
        className="logo"
      />
      <div className="menu-container">
        ...
        <ul className={`nav-links ${menuOpen ? "open" : ""}`}>
          <li className="dropdown" onClick={() => toggleDropdown(0)}>
            Cameras {arrowIcon}
            <ul
              className={`dropdown-content ${dropdownOpen === 0 ? "show" : ""}`}
            >
              <li>Video</li>
              <li>Cine</li>
              <li>Photo</li>
          ...
          <li className="dropdown" onClick={() => toggleDropdown(1)}>
            ...
            <ul
              className={`dropdown-content ${dropdownOpen === 1 ? "show" : ""}`}
            >
              <li>Photo Lenses</li>
              <li>Cine Lenses</li>
              <li>Filters</li>
          ...
          <li className="dropdown" onClick={() => toggleDropdown(2)}>
            ...
            <ul
              className={`dropdown-content ${dropdownOpen === 2 ? "show" : ""}`}
            >
              <li>Batteries</li>
              <li>Cables</li>
              <li>Follow Focus</li>
          ...
          <li className="dropdown" onClick={() => toggleDropdown(3)}>
            Grip {arrowIcon}
            <ul
              className={`dropdown-content ${dropdownOpen === 3 ? "show" : ""}`}
            >
              <li>Booms</li>
              <li>Tripods</li>
              <li>Heads</li>
